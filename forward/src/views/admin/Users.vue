    ...
    >
      <el-form :model="userForm" label-width="100px" :rules="userRules" ref="userFormRef">
        ...
        <el-form-item label="姓名">
          <el-row :gutter="10">
            <el-col :span="12">
              <el-input v-model="userForm.last_name" placeholder="姓" />
            </el-col>
            <el-col :span="12">
              <el-input v-model="userForm.first_name" placeholder="名" />
            </el-col>
          </el-row>
        </el-form-item>
        <el-form-item label="学号/工号">
          <el-input v-model="userForm.student_no" placeholder="请输入学号或工号" />
        </el-form-item>
...
const editUser = (row) => {
  ...
  userForm.student_no = row.student_no
